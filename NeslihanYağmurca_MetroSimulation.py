...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        # (istasyon, rota, aktarma_sayisi) tuple'ları için kuyruk
        kuyruk = deque([(baslangic, [baslangic], 0)])
        ziyaret_edildi = {(baslangic, 0)}  # (istasyon, aktarma_sayisi) tuple'ları
        ...
        while kuyruk:
            ...
            for komsu, _ in mevcut.komsular:
                ...
                durum = (komsu, yeni_aktarma)
                
                if durum not in ziyaret_edildi:
                    ziyaret_edildi.add(durum)
                    yeni_rota = rota + [komsu]
                    kuyruk.append((komsu, yeni_rota, yeni_aktarma))
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        # (toplam_sure, id(istasyon), istasyon, rota) tuple'ları için öncelik kuyruğu
